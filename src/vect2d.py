...
class Vec(list):
    ...
    def __add__(self, other): return type(self)(self[0] + other[0], self[1] + other[1])

    def __radd__(self, other): return self + other

    def __sub__(self, other): return  type(self)(self[0] - other[0], self[1] - other[1])
    ...
    def __lt__(self, a): return abs(self[0])<a and abs(self[1])<a
    def __gt__(self, a): return abs(self[0])>a and abs(self[1])>a
    
    def __abs__(self): return abs(self[0]), abs(self[1])
    def __neg__(self): return type(self)(-self[0], -self[1])
